...
publish(paste0("<center><h3><u>Contrast:</u>  ",contrastname), des2Report)
...
publish(resNorm,des2Report, contrast=contrastname, pvalueCutoff=1, DataSet=dds, n=100, factor=colData(dds)[[condition]])
